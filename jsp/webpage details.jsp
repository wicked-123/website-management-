...
try
{
    ...
    ResultSet flag=stmt.executeQuery("select * from webpages");
    if(flag.next())
    {
        ResultSet rs=stmt.executeQuery("select * from webpages");
        ResultSetMetaData rsmd=rs.getMetaData();
        int n=rsmd.getColumnCount();
        out.print("<body><center><head>webpage details</head><br><br><br><br><br><br><table><tr>");
        for(int i=1;i<=n;i++)
